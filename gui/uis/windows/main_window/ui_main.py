...
class UI_MainWindow(object):
    # 这里的parent指的是main函数的类
    def setup_ui(self, parent):
        if not parent.objectName():
            parent.setObjectName("MainWindow")

        # LOAD SETTINGS 窗口大小，侧边栏宽度等设置参数 字体
        # ///////////////////////////////////////////////////////////////
        settings = Settings()
        self.settings = settings.items

        # LOAD THEME COLOR 各种组件颜色
        # ///////////////////////////////////////////////////////////////
        themes = Themes()
        self.themes = themes.items

        # SET INITIAL PARAMETERS 初始窗口大小
        ...
        # ADD RIGHT APP LAYOUT 设置右边的应用布局为垂直布局
        ...
        # window本质上只包含三部分 ： 左边菜单，左边列，右边app，但是app又包含了三部分，
        # 就是上面的right_app_layout，layout中添加三个frame，导航栏、内容区域、credits区域
        # 内容区域又包含了：左边内容区域、右边的列

        # 左边内容区域呢是一个Frame (content_area_left_frame)
        # 这个Frame传给了Ui_MainPages类的setupUi()方法，所以主体内容还是看Ui_MainPages类
        # ///////////////////////////////////////////////////////////////
